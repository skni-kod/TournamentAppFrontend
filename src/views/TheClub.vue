...
export default class ClubPage extends Vue{
    ...
    generateFlagURL(){
        return "https://www.countryflagicons.com/SHINY/32/"  + this.$data.club.country + ".png";
    }
